      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 text-light">
          ...
          <li class="nav-item">
           ...
           <!--Change To ONLY !Session::has('client') -->
            <?php if( Session::has('client') || !Session::has('client') ): ?>
            ...
            <!--Change To ONLY !Session::has('admin') -->
             <?php if( Session::has('admin') || !Session::has('admin')): ?>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                      Client
                    </a>
...
</html><?php /**PATH C:\Users\Salman\Desktop\LMS\LMS\resources\views/layouts/main.blade.php ENDPATH**/ ?>